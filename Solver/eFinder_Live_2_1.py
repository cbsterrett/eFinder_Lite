...
def access_Seestar():
    ...
    if seestar_access != True: # lets get the Seestar ready
        ...
        seestar = seestar_scopedog.Seestar(handpad,geoloc.get_lat(),geoloc.get_long(),param['Seestar_ssid'],param['Seestar_password'])
        seestar_access = True
...
summary = ["","", "", "up_down(-1)", "up_down(1)", "", "left_right(1)", "go_solve()", "setWifi()"]
exp = [
    "Exposure",
    param["Exposure"],
    "",
